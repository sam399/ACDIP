...
from app.routers import dashboard, donations, emergencies, people, recovery, resources, shelters, chatbot, settings_support
...
def create_app() -> FastAPI:
    ...
    application.include_router(settings_support.router)
    return application
